...
namespace TryGet.Samples.Net
{
    ...
    /// 是 Net 端"如何用 GameLauncher 启动框架"的范本，可被业务直接拷贝改造。
    ///
    ...
    public static class Entry
    {
        ...
        /// <param name="options">GameLauncher 配置（可选）。</param>
        ...
        public static int Run(
            Action<IModuleSystem> setup,
            Func<IModuleSystem, TGTask> mainAsync,
            GameLauncherOptions options = null,
            int frameSleepMs = 16,
            long timeoutMs = -1)
        {
